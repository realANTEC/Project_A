  ...
  return (
    <Page className="flex justify-center gap-7">
      <main className="w-full max-w-[600px]">
        ...
        <div className="sticky top-16 z-30 mb-4 flex justify-center bg-gradient-to-b from-canvas via-canvas/85 to-transparent py-3 backdrop-blur-md lg:top-0 lg:pt-6">
